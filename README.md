...
- `docker/base/Dockerfile`: shared toolchain image (Node.js, Python, PHP, Go, PostgreSQL 16, Git, shell utilities, and more) used by the unified agent image
...
3. **`.powbox.yml` / `.powbox.local.yml`** — reads custom `shadow` glob patterns (see below)
