...
Concrete recipe — self-hosted Claude on the `main` branch of `Roubtec/agent-skills`, named `skills` (substitute repo/branch/name for your own; swap `cc` for `cx` to launch Codex instead — nothing else changes):
