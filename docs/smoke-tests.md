...
An entry naming no skip control was decided by the host at runtime: there is nothing set to unset, and it comes back only when the host can provide what the stage needs.
